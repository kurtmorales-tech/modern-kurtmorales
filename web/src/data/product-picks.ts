...
export const productPlatforms: ProductPlatform[] = [
  {
    ...
    description: 'Useful accessories, desk add-ons, and impulse-friendly product ideas you can review or round up later.',
    angle: 'Good for visual lists, quick buys, and lower-cost setup extras.',
    products: [
      {
        name: 'Adjustable phone stand',
        category: 'Desk accessory',
        summary: 'Simple foldable stand for recording, browsing, or keeping a phone visible at a workstation.',
      ...
      },
      {
        ...
        category: 'Lighting',
        summary: 'Compact accent light for shelves, desk scenes, or background glow in content setups.',
      },
      {
        name: 'Monitor riser shelf',
        category: 'Workspace',
        summary: 'Basic riser to lift screens, open more space underneath, and improve layout photos.',
      },
      {
  ...
  },
  {
    ...
    description: 'Reliable, familiar products for workstations, creator kits, and office-tech recommendations.',
    angle: 'Best for mainstream gear lists and products people already trust.',
    products: [
      {
        name: 'USB-C docking hub',
        category: 'Tech',
        summary: 'Multi-port hub for laptops, monitors, drives, and charging in one simple desk setup.',
      },
      {
        name: '1080p webcam',
        category: 'Creator gear',
        summary: 'Clean video option for meetings, livestreams, or better-looking tutorial content.',
      },
      {
      ...
      },
      {
        name: 'Portable SSD',
        category: 'Storage',
        summary: 'Fast external storage for media backups, content transfers, and project archives.',
      },
      {
        name: 'Ring light kit',
        category: 'Lighting',
        summary: 'Classic starter lighting option for better product shots and face lighting indoors.',
      },
    ],
  },
  {
    ...
    description: 'Fast-moving creator-focused products and visually strong items that fit short-form content.',
    ...
    products: [
      ...
      },
      {
        ...
        summary: 'Visual upgrade for vanity, studio, or product display content where lighting matters.',
      },
      {
        name: 'Non-slip desk mat',
        category: 'Workspace',
        summary: 'Large desk mat that improves visuals for keyboard, mouse, and top-down product shots.',
      },
      {
  ...
  },
  {
    ...
    description: 'Supplier-style listings, packaging ideas, and bulk order products for resell or brand packaging research.',
    angle: 'Useful for sourcing pages, supplier roundups, or custom packaging research.',
    products: [
      {
        name: 'Custom shipping boxes',
        category: 'Packaging',
        summary: 'Branded box sourcing idea for ecommerce shipments, kits, or product packaging upgrades.',
      },
      {
      ...
      },
      {
        ...
        summary: 'Low-cost accessory idea for branded giveaways, resale bundles, or campaign packs.',
      },
      {
        name: 'Sample neon sign',
        category: 'Branding',
        summary: 'Decor or branded backdrop item for content sets, studios, booths, or retail corners.',
      },
      {
