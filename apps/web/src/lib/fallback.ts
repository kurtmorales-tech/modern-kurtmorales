import type { Post, Project, Template } from '../types';
import generatedRssPosts from '../data/generated-rss-posts.json';
import howToPosts from '../data/how-to-posts.json';

export const fallbackPosts: Post[] = [
  ...(howToPosts as Post[]),
  ...(generatedRssPosts as Post[]),
  {
    id: 'f1',
...
export const fallbackTemplates: Template[] = [
  ...
  },
  {
    ...
    thumbnail: {
      url: '/template-previews/securepass.png',
      alt: 'SecurePass template preview',
    },
